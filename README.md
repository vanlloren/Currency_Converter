This project is a simple implementation of a currency conversion tool. The first version is able to convert 10 different currencies (USD, EUR, GBP, RUB, JPY, CHF, CNY, ARS, BRL, INR)
